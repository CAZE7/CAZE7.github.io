...
1. **Lese den Code aus der Anpassung aus:**
    ...
    Kanal: Bestätigung der Einbauänderung (Confirmation of installation change)
    ```
...
<div class="md-grid cards" style="margin-top: 2rem;">
  <div style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(128,128,128,0.2); border-radius: 12px; padding: 2rem;">
    ...
    <label for="calcCode" style="display: block; font-weight: bold; margin-bottom: 0.5rem; color: var(--md-accent-fg-color);">Generierter Bestätigungscode:</label>
    <input type="text" id="calcCode" name="calcCode" readonly style="width: 100%; padding: 0.75rem; border-radius: 8px; border: 1px solid var(--md-accent-fg-color); background: rgba(244, 63, 94, 0.1); color: var(--md-accent-fg-color); font-family: var(--md-code-font); font-weight: bold; font-size: 1.1em;">
